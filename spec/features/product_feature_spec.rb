...
RSpec.describe "Products", type: :feature do
  ...
  describe "creating products" do
    it 'shows created product and does not redirect', js: :true do
      # I am commenting out these tests since they will not work on my
      # system/setup. I'm programming on WIn10 with the Learn IDE. Firefox is
      # installed and I've tried specifying the file path in the spec helper to
      # no avail. These tests are working as described. Please contact with any
